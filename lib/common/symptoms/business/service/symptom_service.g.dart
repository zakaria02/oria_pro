...
class _SymptomService implements SymptomService {
  ...
  @override
  Future<void> deleteUserSymptom(DeleteSymptomRequestModel request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<SymptomContentModel> getSymptomContent(String symptomId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SymptomContentModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/learning/symptom-explore/${symptomId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = SymptomContentModel.fromJson(_result.data!);
    return value;
  }

  @override
  Future<void> setTodaysActionsProgram(SetTodaysActionsProgram request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<TodaysActionProgramsResponse> getTodayActionsProgram() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<TodaysActionProgramsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/learning/daily-actions/get-programs',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = TodaysActionProgramsResponse.fromJson(_result.data!);
    return value;
  }
