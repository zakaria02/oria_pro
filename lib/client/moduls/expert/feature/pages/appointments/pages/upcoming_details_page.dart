...
class UpcomingDetailsPage extends StatefulWidget {
  const UpcomingDetailsPage({super.key, required this.appointmentId});
...
class _UpcomingDetailsPageState extends State<UpcomingDetailsPage> {
  ...
  void _startTimer(AppointmentDetails appointment) {
    if (duration == null) {
      const oneSecond = Duration(seconds: 1);
      _timer = Timer.periodic(oneSecond, (Timer timer) {
        setState(() {
          duration = appointment.date.difference(DateTime.now());
        });
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          AppointmentBloc()..add(FetchAppointment(id: widget.appointmentId)),
      child: BlocBuilder<AppointmentBloc, AppointmentState>(
        builder: (blocContext, state) {
          if (state.currentAppointment != null) {
            _startTimer(state.currentAppointment!);
          }
          return OriaScaffold(
            ...
            body: state is FetchCurrentAppointmentLoading
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const Spacer(),
                                      Text(
                                        state.currentAppointment!.date
                                            .toAbbreviationMonthDate(
                                          context,
                                          withTime: true,
                                        ),
                                        style: Theme.of(context)
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        AppLocalizations.of(context)!.minutes(
                                            state.currentAppointment!.duration),
                                        style: Theme.of(context)
                                            .textTheme
                                            .displayMedium
                                            ?.copyWith(fontFamily: "Satoshi"),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              "${state.currentAppointment!.expert.firstName} ${state.currentAppointment!.expert.lastName}",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .displayLarge,
                                            ),
                                            Text(
                                              state.currentAppointment!.expert
                                                  .specialty,
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .bodyMedium
                                  ...
                                  if (state.currentAppointment!.status ==
                                          AppointmentStatus.finished &&
                                      state.currentAppointment!.hasFile)
                                    GestureDetector(
                                      onTap: () async {
                                        if (filePath == null) {
